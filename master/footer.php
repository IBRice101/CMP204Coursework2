<footer>
	...
	<div class="themeSwitchButtonDiv">
		...
		<br/>
		<button type="button" class="themeSwitchButton" id="themeSwitchLight" onclick="ChangeThemeLight()">
			Light Theme</button>
		<button type="button" class="themeSwitchButton" id="themeSwitchDark" onclick="ChangeThemeDark()">
			Dark Theme</button>
	</div>
</footer>