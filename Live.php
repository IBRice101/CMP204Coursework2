    ...
    <?php include 'master\header.php' ?>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col">
                    <iframe src="https://open.spotify.com/embed/album/3Bz2QPL8NLBn1d03jXtNkT" width="300" height="380"  allowtransparency="true" allow="encrypted-media"></iframe>
                    <iframe src="https://open.spotify.com/embed/album/3Z7mPCcnwAzU7GtsRYf0HA" width="300" height="100"  allowtransparency="true" allow="encrypted-media"></iframe>
                </div>
            </div>
            <div class="row">
                <div class="col">
